...
liste_chemin = []
# On crée cette liste en tant que variable gloable pour enregistrer les resultats des fonctions gauche
...
def couleur():  # changer couleur de la tortue à fonction de typecellule
    ...
    if typeCellule(pixel2cell(object.xcor(), object.ycor())[0],
        ...
        object.color("greenyellow")
                     ...
                     pixel2cell(object.xcor(), object.ycor())[1]) == "passage standard":
        object.color("pink")
